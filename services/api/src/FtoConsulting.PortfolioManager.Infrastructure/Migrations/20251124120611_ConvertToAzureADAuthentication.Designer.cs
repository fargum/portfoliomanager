...
namespace FtoConsulting.PortfolioManager.Infrastructure.Migrations
{
    ...
    [Migration("20251124120611_ConvertToAzureADAuthentication")]
    partial class ConvertToAzureADAuthentication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FtoConsulting.PortfolioManager.Domain.Entities.SecurityIncident", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ThreatLevel", "IsResolved")
                        .HasDatabaseName("ix_security_incidents_threat_level_resolved");

                    b.ToTable("security_incidents", "app");
                });
            ...
            modelBuilder.Entity("FtoConsulting.PortfolioManager.Domain.Entities.SecurityIncident", b =>
                {
                    b.HasOne("FtoConsulting.PortfolioManager.Domain.Entities.Account", null)
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
